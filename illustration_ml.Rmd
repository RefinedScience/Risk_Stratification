...
# Overview
This HTML report demonstrates an application for the development of a counterfactual model, as described in the manuscript. The models were developed based on the synthetic survival dataset. Note that the synthetic dataset was generated only for the purpose of exposition and does not mean anything clinically meaningful or convey any relevant association with overall survival.
